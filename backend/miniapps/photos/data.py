...
class PhotoAsset(Model):
    ...
    # metadata
    width: Mapped[float|None] = mapped_column(Float, default=None, nullable=True)
    height: Mapped[float|None] = mapped_column(Float, default=None, nullable=True)
    ...
    orientation: Mapped[PhotoAssetOrientation|None] = mapped_column(Enum(PhotoAssetOrientation), default=None, nullable=True)
